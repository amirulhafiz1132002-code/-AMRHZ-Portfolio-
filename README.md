...
- Automated testing pipelines (tests/)
- Security policy and data contracts for enterprise readiness
...
`bash
git clone https://github.com/amirulhafiz1132002-code/AP1-WEB-Console.git
cd AP1-WEB-Console
...
- 🔮 Planned: CI/CD workflows, dark/light mode themes, advanced telemetry dashboard  
